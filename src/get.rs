...
//实现Get请求
impl Get {
    pub fn new(_url:&str,_acting:&str,_path:&str,_time_out:&str,_jump:bool,_header:&str) -> Get {
        return Get { 
            url: _url.to_string(),
    ...
    pub async fn out(&self) -> Result<HashMap<String, String>, Box<dyn Error>> {
        ...
        //开启代理版本
        async fn send_acting(data:&Get) -> Result<HashMap<String, String>, Box<dyn Error>> {
